...
CKEDITOR.dtd.$blockLimit);a.config.div_wrapTable&&(delete f.td,delete f.th);return f}(),u=CKEDITOR.dtd.div,n={},p=[];return{title:a.lang.div.title,minWidth:400,minHeight:165,contents:[{id:"info",label:a.lang.common.generalTab,title:a.lang.common.generalTab,elements:[{type:"hbox",widths:["50%","50%"],
children:[
	{
		id:"elementStyle",
		type:"select",
		...
		onChange:function(){var f=["info:elementStyle","info:class",
		...
		commit:function(f){var c;(c=this.getValue())?n[c].applyToObject(f,a):f.removeAttribute("style")}
	},
	{
		id:"elementStyle",
		type:"text",
	...
	},
	{
		...
		"default":"",
		items:[[a.lang.common.notSet,""],["one","one"],["two","two"],["three","three"],["four","four"]]
	},
	{
		id:"style",
		type:"text",
