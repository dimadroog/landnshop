		...
		return {
			...
			onOk: function() {
				...
				for ( var i = 0; i < size; i++ ) {
					...
					// console.log(containers[ i ].getAttribute( 'droog_style'));
					if (containers[ i ].getAttribute( 'droog_style')){
						containers[ i ].setAttribute('style', containers[ i ].getAttribute( 'droog_style'));
						containers[ i ].removeAttribute( 'droog_style' );
						console.log(containers[ i ].getAttribute( 'style'));
					}
				}
