...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6"> 
                <h4><a href="<?php echo Yii::app()->createUrl('/order/admin/'); ?>">Заказы</a></h4>
                <p class="text-muted">Управление заказами</p>
            </div>
            <div class="col-sm-6 right-to-left">  
                <a class="btn btn-xs btn-primary" href="<?php echo Yii::app()->createUrl('/order/admin/'); ?>">Перейти</a>
            </div>
        </div>
    </div>
</div>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6"> 
                <h4><a href="<?php echo Yii::app()->createUrl('/customer/admin/'); ?>">Клиенты</a></h4>
                <p class="text-muted">Управление клиентами</p>
            </div>
            <div class="col-sm-6 right-to-left">  
                <a class="btn btn-xs btn-primary" href="<?php echo Yii::app()->createUrl('/customer/admin/'); ?>">Перейти</a>
            </div>
        </div>
    </div>
</div>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6"> 
                <h4><a href="<?php echo Yii::app()->createUrl('/article/admin/'); ?>">Товары</a></h4>
                <p class="text-muted">Управление товаром</p>
            </div>
            <div class="col-sm-6 right-to-left">  
